...
\*======================================================================*/
	...
	function _striptext($document)
	{
		...
		// I didn't use preg __fn_81673(//e) since that is only available in PHP 4.0.
		...
		$text = __fn_54912($search,$replace,$document);
...
\*======================================================================*/
	...
	function _expandlinks($links,$URI)
	{
		...
		$match = __fn_54912("|/[^\/\.]+\.[^\/\.]+$|","",$match[0]);
		$match = __fn_54912("|/$|","",$match);
		...
		$expandedLinks = __fn_54912($search,$replace,$links);
...
\*======================================================================*/
	...
	function _httpsrequest($url,$URI,$http_method,$content_type="",$body="")
	{
		...
		__fn_40816( $this->curl_path . ' ' . $cmdline_params . ' ' . escapeshellarg( $URI ), $results, $return );
