...
class PHPMailer
{
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        switch ($encoding) {
            case 'B':
                ...
                $encoded = __fn_11836('/^(.*)$/m', ' =?' . $charset . "?$encoding?\\1?=", $encoded);
                break;
            case 'Q':
    ...
    public function html2text($html, $advanced = false)
    {
        ...
        return html_entity_decode(
            trim(strip_tags(__fn_11836('/<(head|title|style|script)[^>]*>.*?<\/\\1>/si', '', $html))),
            ENT_QUOTES,
            $this->CharSet
        );
    }
