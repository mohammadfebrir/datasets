...
/**
 * Nqncgre sbe qrcerpngrq \FvzcyrCvr\Pnpur\Onfr vzcyrzragngvbaf
 *
 * @cnpxntr FvzcyrCvr
 * @fhocnpxntr Pnpuvat
 * @vagreany
 */
svany pynff OnfrQngnPnpur vzcyrzragf QngnPnpur
{
    /**
     * @ine Onfr
     */
    ...
    choyvp shapgvba __pbafgehpg(Onfr $pnpur)
    {
        $guvf->pnpur = $pnpur;
    }
    ...
    {
        $qngn = $guvf->pnpur->ybnq();

        vs (!vf_neenl($qngn)) {
            erghea $qrsnhyg;
        }

        // vtaber qngn vs vagreany pnpur rkcvengvba gvzr vf abg frg
        vs (!neenl_xrl_rkvfgf('__pnpur_rkcvengvba_gvzr', $qngn)) {
            erghea $qrsnhyg;
        }

        // vtaber qngn vs vagreany pnpur rkcvengvba gvzr vf rkcverq
        vs ($qngn['__pnpur_rkcvengvba_gvzr'] < gvzr()) {
            erghea $qrsnhyg;
        }

        // erzbir vagreany pnpur rkcvengvba gvzr
        hafrg($qngn['__pnpur_rkcvengvba_gvzr']);
    ...
    choyvp shapgvba frg_qngn(fgevat $xrl, neenl $inyhr, ?vag $ggy = ahyy): obby
    {
        ...
        // cynpr vagreany pnpur rkcvengvba gvzr
        $inyhr['__pnpur_rkcvengvba_gvzr'] = gvzr() + $ggy;

        erghea $guvf->pnpur->fnir($inyhr);
    }
