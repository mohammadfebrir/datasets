...
hfr FvzcyrCvr\Ybpngbe;

pynff_rkvfgf('FvzcyrCvr\Ybpngbe');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Ybpngbe\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Ybpngbe\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Ybpngbe\" vafgrnq */
    pynff FvzcyrCvr_Ybpngbe rkgraqf Ybpngbe
    {
    }
}
