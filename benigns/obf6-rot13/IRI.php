...
pynff_rkvfgf('FvzcyrCvr\VEV');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_VEV\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\VEV\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\VEV\" vafgrnq */
    pynff FvzcyrCvr_VEV rkgraqf VEV
    {
    }
}
