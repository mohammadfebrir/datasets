...
hfr FvzcyrCvr\Fbhepr;

pynff_rkvfgf('FvzcyrCvr\Fbhepr');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Fbhepr\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Fbhepr\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Fbhepr\" vafgrnq */
    pynff FvzcyrCvr_Fbhepr rkgraqf Fbhepr
    {
    }
}
