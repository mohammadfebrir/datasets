...
hfr FvzcyrCvr\Arg\VCi6;

pynff_rkvfgf('FvzcyrCvr\Arg\VCi6');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Arg_VCi6\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Arg\VCi6\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Arg\VCi6\" vafgrnq */
    pynff FvzcyrCvr_Arg_VCi6 rkgraqf VCi6
    {
    }
}
