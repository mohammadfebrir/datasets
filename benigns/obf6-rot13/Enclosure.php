...
hfr FvzcyrCvr\Rapybfher;

pynff_rkvfgf('FvzcyrCvr\Rapybfher');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Rapybfher\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Rapybfher\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Rapybfher\" vafgrnq */
    pynff FvzcyrCvr_Rapybfher rkgraqf Rapybfher
    {
    }
}
