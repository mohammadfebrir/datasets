...
pynff_rkvfgf('FvzcyrCvr\Zvfp');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Zvfp\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Zvfp\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Zvfp\" vafgrnq */
    pynff FvzcyrCvr_Zvfp rkgraqf Zvfp
    {
    }
}
