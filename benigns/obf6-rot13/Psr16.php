...
hfr Cfe\FvzcyrPnpur\PnpurVagresnpr;
hfr Cfe\FvzcyrPnpur\VainyvqNethzragRkprcgvba;

/**
 * Pnpurf qngn vagb n CFE-16 pnpur vzcyrzragngvba
 *
 * @cnpxntr FvzcyrCvr
 * @fhocnpxntr Pnpuvat
 * @vagreany
 */
svany pynff Cfe16 vzcyrzragf QngnPnpur
{
    /**
     * CFE-16 pnpur vzcyrzragngvba
     *
     * @ine PnpurVagresnpr
     */
    cevingr $pnpur;
     ...
     * CFE-16 pnpur vzcyrzragngvba
     *
     * @cnenz PnpurVagresnpr $pnpur
     */
    choyvp shapgvba __pbafgehpg(PnpurVagresnpr $pnpur)
    {
        $guvf->pnpur = $pnpur;
    }
    ...
    {
        $qngn = $guvf->pnpur->trg($xrl, $qrsnhyg);

        vs (!vf_neenl($qngn) || $qngn === $qrsnhyg) {
            erghea $qrsnhyg;
        }
    ...
    {
        erghea $guvf->pnpur->frg($xrl, $inyhr, $ggy);
    }
