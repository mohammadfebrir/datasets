...
hfr FvzcyrCvr\Pbagrag\Glcr\Favssre;

pynff_rkvfgf('FvzcyrCvr\Pbagrag\Glcr\Favssre');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pbagrag_Glcr_Favssre\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pbagrag\Glcr\Favssre\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pbagrag\Glcr\Favssre\" vafgrnq */
    pynff FvzcyrCvr_Pbagrag_Glcr_Favssre rkgraqf Favssre
    {
    }
}
