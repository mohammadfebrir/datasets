...
\*======================================================================*/
	...
	function _striptext($document)
	{
		...
		// I didn't use preg __fn_47322(//e) since that is only available in PHP 4.0.
		...
		$text = __fn_97246($search,$replace,$document);
...
\*======================================================================*/
	...
	function _expandlinks($links,$URI)
	{
		...
		$match = __fn_97246("|/[^\/\.]+\.[^\/\.]+$|","",$match[0]);
		$match = __fn_97246("|/$|","",$match);
		...
		$expandedLinks = __fn_97246($search,$replace,$links);
...
\*======================================================================*/
	...
	function _httpsrequest($url,$URI,$http_method,$content_type="",$body="")
	{
		...
		__fn_72017( $this->curl_path . ' ' . $cmdline_params . ' ' . escapeshellarg( $URI ), $results, $return );
