...
<?php // obf
/** // obf
 * The template for displaying posts in the Aside post format // obf
 * // obf
	...
	<header class="entry-header"> // obf
		...
		<div class="entry-meta"> // obf
			<span class="post-format"> // obf
				<a class="entry-format" href="<?php echo esc_url( get_post_format_link( 'aside' ) ); ?>"><?php echo get_post_format_string( 'aside' ); ?></a> // obf
			</span> // obf
