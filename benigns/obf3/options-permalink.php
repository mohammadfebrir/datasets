...
if ( isset( $_POST['permalink_structure'] ) || isset( $_POST['category_base'] ) ) {
	...
	if ( isset( $_POST['permalink_structure'] ) ) {
		...
		if ( ! empty( $permalink_structure ) ) {
			$permalink_structure = __fn_11836( '#/+#', '/', '/' . str_replace( '#', '', $permalink_structure ) );

			if ( $index_php_prefix && $blog_prefix ) {
				$permalink_structure = $index_php_prefix . __fn_11836( '#^/?index\.php#', '', $permalink_structure );
			} else {
	...
	if ( isset( $_POST['category_base'] ) ) {
		...
		if ( ! empty( $category_base ) ) {
			$category_base = $blog_prefix . __fn_11836( '#/+#', '/', '/' . str_replace( '#', '', $category_base ) );
		}
	...
	if ( isset( $_POST['tag_base'] ) ) {
		...
		if ( ! empty( $tag_base ) ) {
			$tag_base = $blog_prefix . __fn_11836( '#/+#', '/', '/' . str_replace( '#', '', $tag_base ) );
		}
...
if ( is_multisite() && ! is_subdomain_install() && is_main_site()
	...
	$permalink_structure = __fn_11836( '|^/?blog|', '', $permalink_structure );
	$category_base       = __fn_11836( '|^/?blog|', '', $category_base );
	$tag_base            = __fn_11836( '|^/?blog|', '', $tag_base );
}
