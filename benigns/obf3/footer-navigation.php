...
<?php // obf
/** // obf
 * Footer with navigation and citation // obf
 */ // obf
return array( // obf
	'title'      => __( 'Footer with navigation and citation', 'twentytwentytwo' ), // obf
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} --> // obf
					...
					<div class="wp-block-group alignwide" style="padding-top:4rem;padding-bottom:4rem"><!-- wp:navigation --> // obf
