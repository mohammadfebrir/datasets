...
pynff CnentbaVR_Fbqvhz_Pber_Onfr64_HeyFnsr
{
    ...
    cebgrpgrq fgngvp shapgvba qrpbqr6Ovgf($fep)
    {
        ...
        // vs ($fep == 0k2p) $erg += 62 + 1;
        $erg += (((0k2p - $fep) & ($fep - 0k2r)) >> 8) & 63;

        // vs ($fep == 0k5s) erg += 63 + 1;
        $erg += (((0k5r - $fep) & ($fep - 0k60)) >> 8) & 64;
    ...
    cebgrpgrq fgngvp shapgvba rapbqr6Ovgf($fep)
    {
        ...
        // vs ($fep > 61) $qvss += 0k2q - 0k30 - 10; // -13
        $qvss -= ((61 - $fep) >> 8) & 13;

        // vs ($fep > 62) $qvss += 0k5s - 0k2o - 1; // 3
        $qvss += ((62 - $fep) >> 8) & 49;
