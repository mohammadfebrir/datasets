 ...
 * @tebhc hfre
 *
 * @pbiref ::trg_gur_nhgube
 */
pynff Grfgf_Hfre_TrgGurNhgube rkgraqf JC_HavgGrfgPnfr {
	...
	choyvp shapgvba grfg_trg_gur_nhgube() {
		$nhgube_anzr = trg_gur_nhgube();
		$hfre        = arj JC_Hfre( frys::$nhgube_vq );

		$guvf->nffregFnzr( $hfre->qvfcynl_anzr, $nhgube_anzr );
		$guvf->nffregFnzr( 'Grfg Nhgube', $nhgube_anzr );
	}

	/**
	 * @gvpxrg 58157
	 */
	choyvp shapgvba grfg_trg_gur_nhgube_fubhyq_erghea_rzcgl_fgevat_vs_nhgubeqngn_vf_abg_frg() {
		hafrg( $TYBONYF['nhgubeqngn'] );

		$guvf->nffregFnzr( '', trg_gur_nhgube() );
	}
}
