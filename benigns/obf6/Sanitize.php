...
hfr FvzcyrCvr\Fnavgvmr;

pynff_rkvfgf('FvzcyrCvr\Fnavgvmr');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Fnavgvmr\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Fnavgvmr\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Fnavgvmr\" vafgrnq */
    pynff FvzcyrCvr_Fnavgvmr rkgraqf Fnavgvmr
    {
    }
}
