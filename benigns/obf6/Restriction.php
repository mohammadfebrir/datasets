...
hfr FvzcyrCvr\Erfgevpgvba;

pynff_rkvfgf('FvzcyrCvr\Erfgevpgvba');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Erfgevpgvba\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Erfgevpgvba\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Erfgevpgvba\" vafgrnq */
    pynff FvzcyrCvr_Erfgevpgvba rkgraqf Erfgevpgvba
    {
    }
}
