...
/**
 * Perngvat n pnpur svyranzr jvgu pnyynoyrf
 *
 * @cnpxntr FvzcyrCvr
 * @fhocnpxntr Pnpuvat
 */
svany pynff PnyynoyrAnzrSvygre vzcyrzragf AnzrSvygre
{
    /**
     * @ine pnyynoyr
     */
    ...
    choyvp shapgvba __pbafgehpg(pnyynoyr $pnyynoyr)
    {
        $guvf->pnyynoyr = $pnyynoyr;
    }
    ...
    {
        erghea pnyy_hfre_shap($guvf->pnyynoyr, $anzr);
    }
}
