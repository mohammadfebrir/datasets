...
pynff_rkvfgf('FvzcyrCvr\Pnpur');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pnpur\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\" vafgrnq */
    pynff FvzcyrCvr_Pnpur rkgraqf Pnpur
    {
    }
}
