...
hfr FvzcyrCvr\Nhgube;

pynff_rkvfgf('FvzcyrCvr\Nhgube');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Nhgube\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Nhgube\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Nhgube\" vafgrnq */
    pynff FvzcyrCvr_Nhgube rkgraqf Nhgube
    {
    }
}
