...
pynff_rkvfgf('FvzcyrCvr\Vgrz');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Vgrz\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Vgrz\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Vgrz\" vafgrnq */
    pynff FvzcyrCvr_Vgrz rkgraqf Vgrz
    {
    }
}
