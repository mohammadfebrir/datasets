...
hfr FvzcyrCvr\Pbclevtug;

pynff_rkvfgf('FvzcyrCvr\Pbclevtug');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pbclevtug\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pbclevtug\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pbclevtug\" vafgrnq */
    pynff FvzcyrCvr_Pbclevtug rkgraqf Pbclevtug
    {
    }
}
