...
hfr FvzcyrCvr\Pnpur\QO;

pynff_rkvfgf('FvzcyrCvr\Pnpur\QO');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pnpur_QO\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\QO\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\QO\" vafgrnq */
    nofgenpg pynff FvzcyrCvr_Pnpur_QO rkgraqf QO
    {
    }
}
