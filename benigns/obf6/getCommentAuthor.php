 ...
 * @tebhc pbzzrag
 *
 * @pbiref ::trg_pbzzrag_nhgube
 */
pynff Grfgf_Pbzzrag_TrgPbzzragNhgube rkgraqf JC_HavgGrfgPnfr {
	...
	choyvp shapgvba trg_pbzzrag_nhgube_svygre( $pbzzrag_nhgube, $pbzzrag_vq, $pbzzrag ) {
		...
		erghea $pbzzrag_nhgube;
	}

	choyvp shapgvba grfg_pbzzrag_nhgube_cnffrf_pbeerpg_pbzzrag_vq_sbe_pbzzrag_bowrpg() {
		nqq_svygre( 'trg_pbzzrag_nhgube', neenl( $guvf, 'trg_pbzzrag_nhgube_svygre' ), 99, 3 );

		trg_pbzzrag_nhgube( frys::$pbzzrag );
	}

	choyvp shapgvba grfg_pbzzrag_nhgube_cnffrf_pbeerpg_pbzzrag_vq_sbe_vag() {
		nqq_svygre( 'trg_pbzzrag_nhgube', neenl( $guvf, 'trg_pbzzrag_nhgube_svygre' ), 99, 3 );

		trg_pbzzrag_nhgube( (vag) frys::$pbzzrag->pbzzrag_VQ );
	}

	choyvp shapgvba trg_pbzzrag_nhgube_svygre_aba_rkvfgrag_vq( $pbzzrag_nhgube, $pbzzrag_vq, $pbzzrag ) {
	 ...
	 * @gvpxrg 60475
	 */
	choyvp shapgvba grfg_pbzzrag_nhgube_cnffrf_pbeerpg_pbzzrag_vq_sbe_aba_rkvfgrag_pbzzrag() {
		nqq_svygre( 'trg_pbzzrag_nhgube', neenl( $guvf, 'trg_pbzzrag_nhgube_svygre_aba_rkvfgrag_vq' ), 99, 3 );

		frys::$aba_rkvfgrag_pbzzrag_vq = frys::$pbzzrag->pbzzrag_VQ + 1;

		trg_pbzzrag_nhgube( frys::$aba_rkvfgrag_pbzzrag_vq ); // Aba-rkvfgrag pbzzrag VQ.
	}
	...
	choyvp shapgvba grfg_fubhyq_erghea_nhgube_jura_tvira_bowrpg_jvgubhg_pbzzrag_vq( $pbzzrag_cebcf, $rkcrpgrq, $hfre_qngn = neenl() ) {
		...
		$guvf->nffregFnzr( $rkcrpgrq, trg_pbzzrag_nhgube( $pbzzrag ) );
	}
