...
hfr FvzcyrCvr\Pnpur\Zrzpnpur;

pynff_rkvfgf('FvzcyrCvr\Pnpur\Zrzpnpur');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pnpur_Zrzpnpur\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\Zrzpnpur\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\Zrzpnpur\" vafgrnq */
    pynff FvzcyrCvr_Pnpur_Zrzpnpur rkgraqf Zrzpnpur
    {
    }
}
