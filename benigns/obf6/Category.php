...
hfr FvzcyrCvr\Pngrtbel;

pynff_rkvfgf('FvzcyrCvr\Pngrtbel');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pngrtbel\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pngrtbel\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pngrtbel\" vafgrnq */
    pynff FvzcyrCvr_Pngrtbel rkgraqf Pngrtbel
    {
    }
}
