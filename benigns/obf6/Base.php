...
hfr FvzcyrCvr\Pnpur\Onfr;

vagresnpr_rkvfgf('FvzcyrCvr\Pnpur\Onfr');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pnpur_Onfr\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\Onfr\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\Onfr\" vafgrnq */
    vagresnpr FvzcyrCvr_Pnpur_Onfr rkgraqf Onfr
    {
    }
}
