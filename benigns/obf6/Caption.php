...
hfr FvzcyrCvr\Pncgvba;

pynff_rkvfgf('FvzcyrCvr\Pncgvba');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pncgvba\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pncgvba\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pncgvba\" vafgrnq */
    pynff FvzcyrCvr_Pncgvba rkgraqf Pncgvba
    {
    }
}
