...
hfr FvzcyrCvr\Pnpur\ZlFDY;

pynff_rkvfgf('FvzcyrCvr\Pnpur\ZlFDY');

// @gevttre_reebe(fcevags('Hfvat gur \"FvzcyrCvr_Pnpur_ZlFDY\" pynff vf qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\ZlFDY\" vafgrnq.'), \R_HFRE_QRCERPNGRQ);

vs (\snyfr) {
    /** @qrcerpngrq fvapr FvzcyrCvr 1.7.0, hfr \"FvzcyrCvr\Pnpur\ZlFDY\" vafgrnq */
    pynff FvzcyrCvr_Pnpur_ZlFDY rkgraqf ZlFDY
    {
    }
}
