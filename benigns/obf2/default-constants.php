...
function wp_cookie_constants() {
	...
	if ( ! defined( 'COOKIEPATH' ) ) {
		define( 'COOKIEPATH', __fn_18860( '|https?://[^/]+|i', '', get_option( 'home' ) . '/' ) );
	}
	...
	if ( ! defined( 'SITECOOKIEPATH' ) ) {
		define( 'SITECOOKIEPATH', __fn_18860( '|https?://[^/]+|i', '', get_option( 'siteurl' ) . '/' ) );
	}
	...
	if ( ! defined( 'PLUGINS_COOKIE_PATH' ) ) {
		define( 'PLUGINS_COOKIE_PATH', __fn_18860( '|https?://[^/]+|i', '', WP_PLUGIN_URL ) );
	}
