...
<?php // obf
/** // obf
 * Footer with query, featured images, title, and citation // obf
 */ // obf
return array( // obf
	'title'      => __( 'Footer with query, featured images, title, and citation', 'twentytwentytwo' ), // obf
	'categories' => array( 'footer' ), // obf
	'blockTypes' => array( 'core/template-part/footer' ), // obf
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem"}},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"backgroundColor":"foreground","textColor":"background","layout":{"inherit":true}} --> // obf
					...
					<!-- wp:post-featured-image {"isLink":true,"width":"100%","height":"318px"} /--> // obf
